...
task_sim_nimbus_bridge::BoundingBox BoundingBoxCalculator::computeBoundingBox(sensor_msgs::PointCloud2 cloud)
{
...
task_sim_nimbus_bridge::BoundingBox
...
task_sim_nimbus_bridge::BoundingBox BoundingBoxCalculator::computeBoundingBox(pcl::PointCloud<pcl::PointXYZ>::Ptr cloud)
{
  ...
  //set object shape
  task_sim_nimbus_bridge::BoundingBox bounding_box;
